...
public class beepDATA extends SQLiteOpenHelper {
    public beepDATA(Context context) {
        super(context, "beepDATA.db", null, 1);
    }

    @Override
    public void onCreate(SQLiteDatabase db) {
        Log.d("beepDATA","onCreate called");
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        db.execSQL("DROP TABLE IF EXISTS beepDATA");
        onCreate(db);
    }
}
