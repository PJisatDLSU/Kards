...
class cash_acc : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_cash_acc)
        ...
        amountInput = findViewById(R.id.inputCASH)
        confirmButton = findViewById(R.id.confirm)
        switchButton = findViewById(R.id.switchButton)
        incomeExpenseTextView = findViewById(R.id.incexp)
        cashBalanceTextView = findViewById(R.id.cashBAL)
        ...
        confirmButton.setOnClickListener {
            ...
            val db = cashDATA(this).writableDatabase
    ...
    private fun updateBalance() {
        val db = cashDATA(this).readableDatabase
        ...
        cashBalanceTextView.text = "₱ $balance"
